...
export const TrackerViewContainer = styled.div`
  height: 764px;
  left: 224px;
  top: 175px;
  margin: 0 auto;
...
export const ItemDateDay = styled.div`
  font-weight: 700;
  color: rgb(148 163 184 / 1);
`;
export const ItemDateDate = styled.div`
  color: rgb(22 163 74 /1);
  margin-top: 0.25rem;
  font-size: 13px;
`;
export const ItemDateDayName = styled.div`
  color: rgb(22 163 74 /1);
  margin-top: 0.5rem;
  line-height: 1.75rem;
  font-size: 1.25rem;
...
export const ItemStartTitle = styled.div`
  color: rgb(148 163 184 / 1);
  font-weight: 700;
  font-size: 0.875rem;
  line-height: 1.25rem;
...
`;
export const ItemStartSelect = styled.select`
  color: rgb(22 163 74 /1);
  padding: 0.25rem;
...
export const ItemHoursTitle = styled.div`
  text-align: center;
`;
export const ItemHoursCount = styled.div`
  color: rgb(22 163 74 / 1);
  text-align: center;
  border-radius: 0.375rem;
...
export const SummaryContainer = styled.div`
  ...
  margin: 1rem;
`;
export const SummaryDayFlex = styled.div`
  width: 10rem;
  display: flex;
  justify-content: space-between;
`;
...
export const CalenderModalCloseBtn = styled.button`
  ...
  padding: 0;
`;
export const CalenderModalCloseBtnImg = styled.image`
  width: 1.5rem;
  height: 1.5rem;
`;
...
`;
export const AddDateModalSection = styled.div`
